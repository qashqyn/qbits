...
declare const selectTriggerVariants: (props?: import("class-variance-authority/dist/types").ClassProp | undefined) => string;
...
declare const selectScrollButtonVariants: (props?: import("class-variance-authority/dist/types").ClassProp | undefined) => string;
...
declare const selectContentVariants: (props?: import("class-variance-authority/dist/types").ClassProp | undefined) => string;
...
declare const selectLabelVariants: (props?: import("class-variance-authority/dist/types").ClassProp | undefined) => string;
...
declare const selectItemVariants: (props?: import("class-variance-authority/dist/types").ClassProp | undefined) => string;
...
declare const selectSeparatorVariants: (props?: import("class-variance-authority/dist/types").ClassProp | undefined) => string;
